...
3. [Encryption and Decryption](#encryption-and-decryption)
...
4. [Signing and Verification](#signing-and-verification)
   ...
   - [Advanced Signing Options](#advanced-signing-options)
...
5. [Web Key Directory (WKD)](#web-key-directory-wkd)
...
8. [Troubleshooting and Common Issues](#troubleshooting-and-common-issues)
   ...
   - [Trust Database Issues](#trust-database-issues)
